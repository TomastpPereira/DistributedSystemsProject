    ...
    private static void runAdminClient(Scanner scanner) {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 4 -> {
                    System.out.print("Enter Share ID to Buy: ");
                    shareID = scanner.nextLine();
                    ...
                    log.logEntry("Client", "purchase", BufferedLog.RequestResponseStatus.SUCCESS, res, "Swap shares");
                ...
                case 5 -> {
                    ...
                    int qty = scanner.nextInt();
                    scanner.nextLine();
                    String res = stub.sellShare(userID, shareID, qty);
                ...
                case 7 -> {
                    ...
                    String res = stub.swapShares(userID, shareID, shareType, newShareID, newShareType);
        ...
        while (true) {
            ...
            switch (choice) {
                case 1 -> {
                    ...
                    int qty = scanner.nextInt();
                    String datemonthyear = shareID.substring(4, shareID.length());
                    String res = marketStub.purchaseShare(userID, shareID, shareType, qty,  datemonthyear);
                    log.logEntry("Client", "purchase", BufferedLog.RequestResponseStatus.SUCCESS, res, "Swap shares");
                    System.out.println(res);
                }
                case 2 -> {
